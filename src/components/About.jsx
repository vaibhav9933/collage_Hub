export default function About() {
  return (
    <section id="about" className="bg-[#fff4f0] px-4 py-20">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="mb-6 text-4xl font-bold text-[#172033] md:text-5xl">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#ef6f61] font-bold text-white">
                  ✓
                </div>
          ...
          <div>
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-2xl border border-white bg-white p-8 text-center shadow-sm">
