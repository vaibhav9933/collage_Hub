...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 bg-white/85 backdrop-blur-lg border-b border-slate-200/70 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <a href="#" className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-sky-600 to-fuchsia-600 bg-clip-text text-transparent">
            🎓 College Hub
          </a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#contact" className="rounded-full bg-gradient-to-r from-sky-600 to-fuchsia-600 px-6 py-2 text-white font-semibold shadow-lg hover:opacity-95 transition">
              Get Started
            </a>
          </div>

          <div className="md:hidden flex items-center">
            <button onClick={() => setIsOpen(!isOpen)} className="text-slate-700 hover:text-sky-600 transition">
